...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// </summary>
    public class ConsumerUpdateProvisionalIHIClient : IConsumerUpdateProvisionalIHIClient
    {
        internal ConsumerUpdateProvisionalIHIPortType updateProvisionalIhiClient;
        ...
        /// HI service name.
        /// </summary>
        public const string HIServiceOperation = "ConsumerUpdateProvisionalIHI";
        ...
        /// <summary>
        /// Initializes an instance of the ConsumerUpdateProvisionalIhi.
        /// </summary>
        /// <param name="endpointUri">Web service endpoint for Medicare's consumer Update Provisional Ihi service.</param>
        ...
        public ConsumerUpdateProvisionalIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        public ConsumerUpdateProvisionalIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointUri", endpointUri);
        ...
        /// Initializes an instance of the ConsumerUpdateProvisionalIhi.
        /// </summary>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the Update Provisional Ihi endpoint.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        /// <param name="hpio">Identifier for the organisation.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        public ConsumerUpdateProvisionalIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="initialisationCallback">Callback for additional configuration after creation.</param>
        public ConsumerUpdateProvisionalIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointConfigurationName", endpointConfigurationName);
        ...
        /// </summary>
        public updateProvisionalIHIResponse UpdateProvisionalIhi(updateProvisionalIHI request)
        {
            ...
            return IHIUpdateProvisional(request);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="UpdateProvisionalIhi" />.
        /// </summary>
        public async Task<updateProvisionalIHIResponse> UpdateProvisionalIhiAsync(updateProvisionalIHI request)
        {
            Validation.ValidateArgumentRequired("request", request);
            Validation.ValidateDateTime("request.dateOfBirth", request.dateOfBirth);
            Validation.ValidateArgumentRequired("request.dateOfBirthAccuracyIndicator", request.dateOfBirthAccuracyIndicator);
            ...
            return await IHIUpdateProvisionalAsync(request);
        }
        ...
        /// </summary>
        /// <param name="request">The criteria in a updateProvisionalIHI object.</param>
        /// <returns>The IHI create results.</returns>
        private updateProvisionalIHIResponse IHIUpdateProvisional(updateProvisionalIHI request)
        {
            updateProvisionalIHIRequest envelope = new updateProvisionalIHIRequest();

            envelope.updateProvisionalIHI = request;
            ...
            updateProvisionalIHIResponse1 response1 = null;

            try
            {
                response1 = updateProvisionalIhiClient.updateProvisionalIHI(envelope);
            }
            catch (Exception ex)
            {
            ...
            if (response1 != null && response1.updateProvisionalIHIResponse != null)
                return response1.updateProvisionalIHIResponse;
            else
                throw new ApplicationException(Properties.Resources.UnexpectedServiceResponse);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="IHIUpdateProvisional" />.
        /// </summary>
        private async Task<updateProvisionalIHIResponse> IHIUpdateProvisionalAsync(updateProvisionalIHI request)
        {
            updateProvisionalIHIRequest envelope = new updateProvisionalIHIRequest();
            ...
            try
            {
                response1 = await updateProvisionalIhiClient.updateProvisionalIHIAsync(envelope);
            }
            catch (Exception ex)
            {
                // Catch generic FaultException and call helper to throw a more specific fault
        ...
        /// Initializes an instance of the ConsumerUpdateProvisionalIhi.
        /// </summary>
        /// <param name="endpointUrl">Web service endpoint for Medicare's consumer Update Provisional IHI service.</param>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the ConsumerUpdateProvisionalIHI endpoint.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        ...
        private void InitializeClient(string endpointUrl, string endpointConfigurationName, X509Certificate2 signingCert, X509Certificate2 tlsCert, ProductType product, QualifiedId user, QualifiedId hpio, Action<ServiceEndpoint> initialisationCallback = null)
        {
            ...
            ConsumerUpdateProvisionalIHIPortTypeClient client = null;
            ...
            if (!string.IsNullOrEmpty(endpointUrl))
            {
                ...
                client = new ConsumerUpdateProvisionalIHIPortTypeClient(tlsBinding, address);
            }
            else if (!string.IsNullOrEmpty(endpointConfigurationName))
            {
                client = new ConsumerUpdateProvisionalIHIPortTypeClient(endpointConfigurationName);
            }
            ...
            if (client != null)
            {
                ...
                updateProvisionalIhiClient = client;
        ...
        public void Dispose()
        {
            ClientBase<ConsumerUpdateProvisionalIHIPortType> createClient;

            if (updateProvisionalIhiClient is ClientBase<ConsumerUpdateProvisionalIHIPortType>)
            {
                createClient = (ClientBase<ConsumerUpdateProvisionalIHIPortType>)updateProvisionalIhiClient;
