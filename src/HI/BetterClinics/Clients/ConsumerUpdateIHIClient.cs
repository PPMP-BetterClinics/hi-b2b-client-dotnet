...
namespace Nehta.VendorLibrary.HI
{
    ...
    public class ConsumerUpdateIHIClient : IConsumerUpdateIHIClient
    {
        ...
        /// </summary>
        /// <param name="endpointUri">Web service endpoint for Medicare's consumer Update  Ihi service.</param>
        ...
        /// Initializes an instance of the ConsumerUpdateIhi.
        /// </summary>
        /// <param name="endpointUri">Web service endpoint for Medicare's consumer Create  Ihi service.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        /// <param name="hpio">Identifier for the organisation.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        ...
        /// Initializes an instance of the ConsumerUpdateIhi.
        /// </summary>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the Update  Ihi endpoint.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        /// <param name="hpio">Identifier for the organisation.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        ...
        public async Task<updateIHIResponse> UpdateIhiAsync(updateIHI request)
        {
            ...
            return await IHIUpdateAsync(request);
        }
        ...
        /// <summary>
        /// Asynchronous implementation of <see cref="IHIUpdate" />.
        /// </summary>
        private async Task<updateIHIResponse> IHIUpdateAsync(updateIHI request)
        {
            updateIHIRequest envelope = new updateIHIRequest();
        ...
        /// Initializes an instance of the ConsumerUpdateIhi.
        /// </summary>
        /// <param name="endpointUrl">Web service endpoint for Medicare's consumer Update  IHI service.</param>
