...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// </summary>
    public class ConsumerMergeProvisionalIHIClient : IConsumerMergeProvisionalIHIClient
    {
        internal ConsumerMergeProvisionalIHIPortType mergeProvisionalIhiClient;
        ...
        /// HI service name.
        /// </summary>
        public const string HIServiceOperation = "ConsumerMergeProvisionalIHI";
        ...
        /// <summary>
        /// Initializes an instance of the ConsumerMergeProvisionalIhi.
        /// </summary>
        /// <param name="endpointUri">Web service endpoint for Medicare's consumer Merge Provisional Ihi service.</param>
        ...
        public ConsumerMergeProvisionalIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        public ConsumerMergeProvisionalIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointUri", endpointUri);
        ...
        /// Initializes an instance of the ConsumerMergeProvisionalIhi.
        /// </summary>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the Merge Provisional Ihi endpoint.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        /// <param name="hpio">Identifier for the organisation.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        public ConsumerMergeProvisionalIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="initialisationCallback">Callback for additional configuration after creation.</param>
        public ConsumerMergeProvisionalIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointConfigurationName", endpointConfigurationName);
        ...
        /// </summary>
        public mergeProvisionalIHIResponse MergeProvisionalIhi(mergeProvisionalIHIRequest request)
        {
            Validation.ValidateArgumentRequired("request", request);

            return IHIMergeProvisional(request);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="MergeProvisionalIhi" />.
        /// </summary>
        public async Task<mergeProvisionalIHIResponse> MergeProvisionalIhiAsync(mergeProvisionalIHIRequest request)
        {
            Validation.ValidateArgumentRequired("request", request);

            return await IHIMergeProvisionalAsync(request);
        }
        ...
        /// </summary>
        /// <param name="request">The criteria in a mergeProvisionalIHI object.</param>
        private mergeProvisionalIHIResponse IHIMergeProvisional(mergeProvisionalIHIRequest request)
        {
            mergeProvisionalIHIRequest envelope = new mergeProvisionalIHIRequest();

            envelope.mergeProvisionalIHI = request.mergeProvisionalIHI;
            ...
            mergeProvisionalIHIResponse1 response1 = null;

            try
            {
                response1 = mergeProvisionalIhiClient.mergeProvisionalIHI(envelope);
            }
            catch (Exception ex)
            {
            ...
            if (response1 != null && response1.mergeProvisionalIHIResponse != null)
                return response1.mergeProvisionalIHIResponse;
            else
                throw new ApplicationException(Properties.Resources.UnexpectedServiceResponse);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="IHIMergeProvisional" />.
        /// </summary>
        private async Task<mergeProvisionalIHIResponse> IHIMergeProvisionalAsync(mergeProvisionalIHIRequest request)
        {
            mergeProvisionalIHIRequest envelope = new mergeProvisionalIHIRequest();
            ...
            try
            {
                response1 = await mergeProvisionalIhiClient.mergeProvisionalIHIAsync(envelope);
            }
            catch (Exception ex)
            {
        ...
        /// Initializes an instance of the ConsumerMergeProvisionalIhi.
        /// </summary>
        /// <param name="endpointUrl">Web service endpoint for Medicare's consumer Merge Provisional IHI service.</param>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the ConsumerMergeProvisionalIHI endpoint.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        ...
        private void InitializeClient(string endpointUrl, string endpointConfigurationName, X509Certificate2 signingCert, X509Certificate2 tlsCert, ProductType product, QualifiedId user, QualifiedId hpio, Action<ServiceEndpoint> initialisationCallback = null)
        {
            ...
            ConsumerMergeProvisionalIHIPortTypeClient client = null;
            ...
            if (!string.IsNullOrEmpty(endpointUrl))
            {
                ...
                client = new ConsumerMergeProvisionalIHIPortTypeClient(tlsBinding, address);
            }
            else if (!string.IsNullOrEmpty(endpointConfigurationName))
            {
                client = new ConsumerMergeProvisionalIHIPortTypeClient(endpointConfigurationName);
            }
            ...
            if (client != null)
            {
                ...
                mergeProvisionalIhiClient = client;
        ...
        public void Dispose()
        {
            ClientBase<ConsumerMergeProvisionalIHIPortType> createClient;

            if (mergeProvisionalIhiClient is ClientBase<ConsumerMergeProvisionalIHIPortType>)
            {
                createClient = (ClientBase<ConsumerMergeProvisionalIHIPortType>)mergeProvisionalIhiClient;
