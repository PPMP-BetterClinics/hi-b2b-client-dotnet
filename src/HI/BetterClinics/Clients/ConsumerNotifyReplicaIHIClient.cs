...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// </summary>
    public class ConsumerNotifyReplicaIHIClient : IConsumerNotifyReplicaIHIClient
    {
        internal ConsumerNotifyReplicaIHIPortType notifyReplicaIhiClient;
        ...
        /// HI service name.
        /// </summary>
        public const string HIServiceOperation = "ConsumerNotifyReplicaIHI";
        ...
        /// <summary>
        /// Initializes an instance of the ConsumerNotifyReplicaIhi.
        /// </summary>
        /// <param name="endpointUri">Web service endpoint for Medicare's consumer Notify Replica Ihi service.</param>
        ...
        public ConsumerNotifyReplicaIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        public ConsumerNotifyReplicaIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointUri", endpointUri);
        ...
        /// Initializes an instance of the ConsumerNotifyReplicaIhi.
        /// </summary>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the Notify Replica Ihi endpoint.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        /// <param name="hpio">Identifier for the organisation.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        public ConsumerNotifyReplicaIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="initialisationCallback">Callback for additional configuration after creation.</param>
        public ConsumerNotifyReplicaIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointConfigurationName", endpointConfigurationName);
        ...
        /// </summary>
        public notifyReplicaIHIResponse NotifyReplicaIhi(notifyReplicaIHI request)
        {
            ...
            return IHINotifyReplica(request);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="NotifyReplicaIhi" />.
        /// </summary>
        public async Task<notifyReplicaIHIResponse> NotifyReplicaIhiAsync(notifyReplicaIHI request)
        {
            Validation.ValidateArgumentRequired("request", request);
            Validation.ValidateArgumentRequired("request.ihiNumber", request.ihiNumber);
            Validation.ValidateArgumentRequired("request.comment", request.comment);

            return await IHINotifyReplicaAsync(request);
        }
        ...
        /// </summary>
        /// <param name="request">The criteria in a notifyReplicaIHI object.</param>
        /// <returns>The IHI create results.</returns>
        private notifyReplicaIHIResponse IHINotifyReplica(notifyReplicaIHI request)
        {
            notifyReplicaIHIRequest envelope = new notifyReplicaIHIRequest();

            envelope.notifyReplicaIHI = request;
            ...
            notifyReplicaIHIResponse1 response1 = null;

            try
            {
                response1 = notifyReplicaIhiClient.notifyReplicaIHI(envelope);
            }
            catch (Exception ex)
            {
            ...
            if (response1 != null && response1.notifyReplicaIHIResponse != null)
                return response1.notifyReplicaIHIResponse;
            else
                throw new ApplicationException(Properties.Resources.UnexpectedServiceResponse);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="IHINotifyReplica" />.
        /// </summary>
        private async Task<notifyReplicaIHIResponse> IHINotifyReplicaAsync(notifyReplicaIHI request)
        {
            notifyReplicaIHIRequest envelope = new notifyReplicaIHIRequest();
            ...
            try
            {
                response1 = await notifyReplicaIhiClient.notifyReplicaIHIAsync(envelope);
            }
            catch (Exception ex)
            {
                // Catch generic FaultException and call helper to throw a more specific fault
        ...
        /// Initializes an instance of the ConsumerNotifyReplicaIhi.
        /// </summary>
        /// <param name="endpointUrl">Web service endpoint for Medicare's consumer Notify Replica IHI service.</param>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the ConsumerNotifyReplicaIHI endpoint.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        ...
        private void InitializeClient(string endpointUrl, string endpointConfigurationName, X509Certificate2 signingCert, X509Certificate2 tlsCert, ProductType product, QualifiedId user, QualifiedId hpio, Action<ServiceEndpoint> initialisationCallback = null)
        {
            ...
            ConsumerNotifyReplicaIHIPortTypeClient client = null;
            ...
            if (!string.IsNullOrEmpty(endpointUrl))
            {
                ...
                client = new ConsumerNotifyReplicaIHIPortTypeClient(tlsBinding, address);
            }
            else if (!string.IsNullOrEmpty(endpointConfigurationName))
            {
                client = new ConsumerNotifyReplicaIHIPortTypeClient(endpointConfigurationName);
            }
        ...
        public void Dispose()
        {
            ClientBase<ConsumerNotifyReplicaIHIPortType> createClient;

            if (notifyReplicaIhiClient is ClientBase<ConsumerNotifyReplicaIHIPortType>)
            {
                createClient = (ClientBase<ConsumerNotifyReplicaIHIPortType>)notifyReplicaIhiClient;
