...
namespace Nehta.VendorLibrary.HI
{
    ...
    /// </summary>
    public class ConsumerCreateProvisionalIHIClient : IConsumerCreateProvisionalIHIClient
    {
        internal ConsumerCreateProvisionalIHIPortType createProvisionalIhiClient;
        ...
        /// HI service name.
        /// </summary>
        public const string HIServiceOperation = "ConsumerCreateProvisionalIHI";
        ...
        /// <summary>
        /// Initializes an instance of the ConsumerCreateProvisionalIhi.
        /// </summary>
        ...
        public ConsumerCreateProvisionalIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        public ConsumerCreateProvisionalIHIClient(Uri endpointUri, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointUri", endpointUri);
        ...
        /// Initializes an instance of the ConsumerCreateProvisionalIhi.
        /// </summary>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the Create Provisional Ihi endpoint.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        /// <param name="hpio">Identifier for the organisation.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        public ConsumerCreateProvisionalIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert)
        {
        ...
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="initialisationCallback">Callback for additional configuration after creation.</param>
        public ConsumerCreateProvisionalIHIClient(string endpointConfigurationName, ProductType product, QualifiedId user, QualifiedId hpio, X509Certificate2 signingCert, X509Certificate2 tlsCert, Action<ServiceEndpoint> initialisationCallback)
        {
            Validation.ValidateArgumentRequired("endpointConfigurationName", endpointConfigurationName);
        ...
        /// </summary>
        public createProvisionalIHIResponse CreateProvisionalIhi(createProvisionalIHI request)
        {
            ...
            return IHICreateProvisional(request);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="CreateProvisionalIhi" />.
        /// </summary>
        public async Task<createProvisionalIHIResponse> CreateProvisionalIhiAsync(createProvisionalIHI request)
        {
            Validation.ValidateArgumentRequired("request", request);
            Validation.ValidateDateTime("request.dateOfBirth", request.dateOfBirth);
            Validation.ValidateArgumentRequired("request.dateOfBirthAccuracyIndicator", request.dateOfBirthAccuracyIndicator);
            ...
            return await IHICreateProvisionalAsync(request);
        }
        ...
        /// </summary>
        /// <param name="request">The criteria in a createProvisionalIHI object.</param>
        /// <returns>The IHI create results.</returns>
        private createProvisionalIHIResponse IHICreateProvisional(createProvisionalIHI request)
        {
            createProvisionalIHIRequest envelope = new createProvisionalIHIRequest();

            envelope.createProvisionalIHI = request;
            ...
            createProvisionalIHIResponse1 response1 = null;

            try
            {
                response1 = createProvisionalIhiClient.createProvisionalIHI(envelope);
            }
            catch (Exception ex)
            {
            ...
            if (response1 != null && response1.createProvisionalIHIResponse != null)
                return response1.createProvisionalIHIResponse;
            else
                throw new ApplicationException(Properties.Resources.UnexpectedServiceResponse);
        }

        /// <summary>
        /// Asynchronous implementation of <see cref="IHICreateProvisional" />.
        /// </summary>
        private async Task<createProvisionalIHIResponse> IHICreateProvisionalAsync(createProvisionalIHI request)
        {
            createProvisionalIHIRequest envelope = new createProvisionalIHIRequest();
            ...
            try
            {
                response1 = await createProvisionalIhiClient.createProvisionalIHIAsync(envelope);
            }
            catch (Exception ex)
            {
                // Catch generic FaultException and call helper to throw a more specific fault
        ...
        /// Initializes an instance of the ConsumerCreateProvisionalIhi.
        /// </summary>
        /// <param name="endpointUrl">Web service endpoint for Medicare's consumer Create Provisional IHI service.</param>
        /// <param name="endpointConfigurationName">Endpoint configuration name for the ConsumerCreateProvisionalIHI endpoint.</param>
        /// <param name="signingCert">Certificate to sign the soap message with.</param>
        /// <param name="tlsCert">Certificate for establishing TLS connection to the HI service.</param>
        /// <param name="product">PCIN (generated by Medicare) and platform name values.</param>
        /// <param name="user">Identifier for the application that is calling the service.</param>
        ...
        private void InitializeClient(string endpointUrl, string endpointConfigurationName, X509Certificate2 signingCert, X509Certificate2 tlsCert, ProductType product, QualifiedId user, QualifiedId hpio, Action<ServiceEndpoint> initialisationCallback = null)
        {
            ...
            ConsumerCreateProvisionalIHIPortTypeClient client = null;
            ...
            if (!string.IsNullOrEmpty(endpointUrl))
            {
                ...
                client = new ConsumerCreateProvisionalIHIPortTypeClient(tlsBinding, address);
            }
            else if (!string.IsNullOrEmpty(endpointConfigurationName))
            {
                client = new ConsumerCreateProvisionalIHIPortTypeClient(endpointConfigurationName);
            }
            ...
            if (client != null)
            {
                ...
                createProvisionalIhiClient = client;
        ...
        public void Dispose()
        {
            ClientBase<ConsumerCreateProvisionalIHIPortType> createClient;

            if (createProvisionalIhiClient is ClientBase<ConsumerCreateProvisionalIHIPortType>)
            {
                createClient = (ClientBase<ConsumerCreateProvisionalIHIPortType>)createProvisionalIhiClient;
